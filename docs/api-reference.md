...
### Example: Using Validation Functions
...
**Expected output:**
```
Caught expected error: Cannot save empty corpus. No documents were processed.
```
...
**No Search Results:**
```
No matches found for query: "abstraction"
```

### Example: Handling Validation Errors in CLI
